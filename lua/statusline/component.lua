...
local M = require('statusline.utils.class'):extend()
...
M.__is_statusline_component = true
...
---called by statusline.utils.sections.draw_section to manage unnecessary separators
...
---create a statusline highlight for color
...
function M:format_fn(id, str)
  return string.format("%%%d@v:lua.require'statusline.utils.fn_store'.call_fn@%s%%T", id, str)
end
