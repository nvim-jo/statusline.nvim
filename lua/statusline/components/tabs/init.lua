...
local Tab = require('statusline.components.tabs.tab')
...
vim.cmd([[
  function! StatuslineSwitchTab(tabnr, mouseclicks, mousebutton, modifiers)
    execute a:tabnr . "tabnext"
  endfunction

  function! StatuslineRenameTab(...)
    if a:0 == 1
      let t:tabname = a:1
    else
      unlet t:tabname
  ...
  command! -nargs=? StatuslineRenameTab call StatuslineRenameTab("<args>")
]])
