local Window = require('statusline.components.windows.window')
local M = require('statusline.components.buffers'):extend()
...
vim.cmd([[
  function! StatuslineSwitchWindow(win_number, mouseclicks, mousebutton, modifiers)
