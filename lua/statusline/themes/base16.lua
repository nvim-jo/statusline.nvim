local modules = require('statusline_require').lazy_require { notices = 'statusline.utils.notices' }
...
local function setup_base16()
  ...
  if not base16.colors and not vim.env.BASE16_THEME then
    add_notice(
      'nvim-base16 is not loaded yet, you should update your configuration to load it before statusline'
