...
if wal_colors_file == nil then
  modules.utils_notices.add_notice('statusline.nvim: ' .. wal_colors_path .. ' not found')
  error('')
end
...
if not ok then
  modules.utils_notices.add_notice('statusline.nvim: ' .. wal_colors_path .. ' could not be read: ' .. wal_colors_text)
  error('')
end
